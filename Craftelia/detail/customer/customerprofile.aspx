            ...
            <div class="row">
                ...
                <div class="col-md-offset-2 col-md-8"> <br /> 
                    <div class="form-div nopadding" style="border:none; background-color:transparent;">
                        <h3>
                            Cusromer Details <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn btn-warning pull-right" PostBackUrl="~/customer/PrimaryShipping.aspx" Font-Size="13px">View Shipping Details</asp:LinkButton>
                        </h3>
                    </div>
