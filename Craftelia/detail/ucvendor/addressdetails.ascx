...
<div class="title">
    <uc1:savediv runat="server" ID="savediv" Visible="false" />
                     ...
                     <div class="form-group"> 
                           ...
                           <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="This Field is Required" ValidationGroup="ad" ControlToValidate="DropDownList2" CssClass="required" InitialValue="0"></asp:RequiredFieldValidator>
                           ...
                           <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ErrorMessage="This Field is Required" ValidationGroup="ad" ControlToValidate="TextBox5" CssClass="required"></asp:RequiredFieldValidator>
                                     ...
                                     <div class="col-md-6">
                                         ...
                                         <asp:TextBox ID="TextBox1" runat="server" placeholder="Locate yourself on google map"></asp:TextBox>
                                          <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="This Field is Required" ValidationGroup="ad" ControlToValidate="TextBox1" CssClass="required"></asp:RequiredFieldValidator>
                ...
                if (status == google.maps.GeocoderStatus.OK) {
                    ...
                    google.maps.event.addListener(marker, "click", function (e) {
                        ...
                        infoWindow.open(map, marker);
                         ...
                         <br />
<asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" ProviderName="<%$ ConnectionStrings:DefaultConnection.ProviderName %>" SelectCommand="SELECT ISNULL(Country, '0') AS Country, ISNULL(City, '') AS City, ISNULL(District, '') AS District, ISNULL(Street, '') AS Street, ISNULL(Building, '') AS Building, isnull(googlemap,'') as googlemap FROM Profile WHERE (UserName = @UserName)" UpdateCommand="UPDATE Profile SET Country = @Country, City = @City, District = @District, Street = @Street, Building = @Building, googlemap = @googlemap WHERE (UserName = @UserName)">
    <SelectParameters>
