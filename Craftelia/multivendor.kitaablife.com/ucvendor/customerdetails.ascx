<%@ Control Language="C#" AutoEventWireup="true" CodeFile="customerdetails.ascx.cs" Inherits="ucvendor_vendor" %>
...
<script type="text/javascript">
 ...
 <div class="title">
     <uc1:savediv runat="server" ID="savediv" Visible="false"/>
                             <asp:Label ID="Label25" runat="server" Text="Your Details:"></asp:Label>
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        ...
        <ContentTemplate>
                                      <div class="col-md-6">
                           <asp:Label ID="Label26" runat="server" Text="Full Name"></asp:Label> 
                     ...
                     <div class="col-md-6">
                           <asp:Label ID="Label27" runat="server" Text="Profile Image"></asp:Label> 
