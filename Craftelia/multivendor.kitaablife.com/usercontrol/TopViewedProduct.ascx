<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TopViewedProduct.ascx.cs" Inherits="usercontrol_TopViewedProduct" %>
...
<div class="col-md-3" style="margin-bottom:20px; padding:5px;">
    <div class="s-product">                          <asp:LinkButton ID="LinkButton1" CommandName="Details" runat="server">
