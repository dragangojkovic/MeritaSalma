<%@ Control Language="C#" AutoEventWireup="true" CodeFile="category-defaultpage - Copy.ascx.cs" Inherits="usercontrol_category" %>
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" ProviderName="<%$ ConnectionStrings:DefaultConnection.ProviderName %>" SelectCommand="SELECT CategoryId, CategoryName, Icon, FrontBanner, Status FROM Category WHERE (Status = N'Active') ORDER BY CategoryName"></asp:SqlDataSource>
   ...
   <div class="col-md-3">
       ...
       <%--  <a class="dropdown-toggle" data-toggle="dropdown" href="#">--%>
         ...
         <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" CommandName="CDetails" CssClass="dropdown-toggle">
        

  <asp:Image ID="Image8" runat="server" ImageUrl='<%# Eval("Icon") %>' Height="150px" ImageAlign="AbsMiddle" Visible="True" Width="100%" /> 
 <asp:Label ID="Label1" runat="server" Text='<%# Eval("CategoryName") %>' Font-Bold="True"></asp:Label>
    ...
    <%--  </a>--%>
           ...
           <asp:ListView ID="ListView2" runat="server" DataSourceID="SqlDataSource2" OnItemCommand="ListView2_ItemCommand" Visible="False">
