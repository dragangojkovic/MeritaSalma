...
public partial class customer_IPNfile : System.Web.UI.Page
{


    string SMTP = "mail.drofixvideo.com";
    string BCC = "imtiaz.makhani@gmail.com";
    string EmailFrom = "admin@drofixvideo.com";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            myString = "Link http://multivendor.com/  Read from IPN <br/>";
