                 ...
                 <div class="inbox row">
                      ...
                      <div class="col-md-4">
                       ...
                       <div class="col-md-1">
                        ...
                        <div class="col-md-1">
                            <asp:Label ID="Label10" runat="server" Text="Total: " Font-Bold="True" ForeColor="Gray" Font-Size="X-Small" CssClass="hidden-lg"></asp:Label>
                           <asp:Label ID="Label12" runat="server" Text='<%# Eval("Currency" ) %>' /><asp:Label ID="Label17" runat="server" Text='<%# Eval("deliverycostperitem" , "{0:n}" ) %>' />
                            <div class="hidden-lg" style="padding: 3px; border-bottom: 1px solid #ccc; margin-bottom: 10px;"></div>
                        </div>
