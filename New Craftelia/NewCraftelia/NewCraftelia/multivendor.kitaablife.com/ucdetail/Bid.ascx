<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Bid.ascx.cs" Inherits="ucdetail_book" %>
...
<div class="row">
 ...
 <div class="col-md-6">
   ...
   Your Bid <small>
           ...
           (It should be greater than last Bid Amount) :  </small>   </h6>
...
<div class="form form-div" id="lastbid" runat="server">
    ...
    Last Bid
    <asp:Label ID="Label1" runat="server" Text="0"></asp:Label>   </h3>
    <br />
Days/Time Remaining:
