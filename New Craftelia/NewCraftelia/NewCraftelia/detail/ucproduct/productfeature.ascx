...
<asp:TextBox ID="TextBox14" runat="server" MaxLength="3" AutoPostBack="True" OnTextChanged="TextBox14_TextChanged">0</asp:TextBox>
...
<p>
    <asp:SqlDataSource ID="SqlDataSource8" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" InsertCommand="INSERT INTO Products(CoverImage, ProductName, SizeId, CategoryId, SubCategoryId, SaleTypeId, StartDate, ExpiryDate, Price, WarrantyId, ConditionId, Brand, CountryofOrigin, Model, Serial, Certificate, DeliveryId, Description, Feature, InsertDate, UserApproval, AdminApproval, UserName, Currency, AvailableQuantity, ProductKey, featurestatus, discountoffer, actualprice, offerexpiry, wholesaleqty, wholesaleprice, enabledeal, demotime) VALUES (@CoverImage, @ProductName, @SizeId, @CategoryId, @SubCategoryId, @SaleTypeId, @StartDate, @ExpiryDate, @Price, @WarrantyId, @ConditionId, @Brand, @CountryOrigin, @Model, @Serial, @Certificate, @DeliveryId, @Description, @Feature, GETDATE(), @UserApproval, @AdminApproval, @UserName, @Currency, @AvailableQuantity, @ProductKey, @FeatureStatus, @discountoffer, @ActualPrice, @offerexpiry, @wholesaleqty, @wholesaleprice, @enabledeal, @demotime)" ProviderName="<%$ ConnectionStrings:DefaultConnection.ProviderName %>" SelectCommand="SELECT ProductKey, CoverImage, ProductName, SizeId, CategoryId, SubCategoryId, SaleTypeId, StartDate, ExpiryDate, Currency, AvailableQuantity, Price, WarrantyId, ConditionId, Brand, CountryofOrigin, Model, Serial, Certificate, DeliveryId, Description, Feature, discountoffer, actualprice, ISNULL(offerexpiry, GETDATE()) AS offerexpiry, ISNULL(wholesaleqty, 0) AS wholesaleqty, ISNULL(wholesaleprice, 0) AS wholesaleprice, ISNULL(enabledeal, 'Discount') AS offerdealtype, isnull(demotime,'1') as demotime FROM Products WHERE (ProductKey = @ProductKey)" UpdateCommand="UPDATE Products SET CoverImage = @CoverImage, ProductName = @ProductName, SizeId = @SizeId, CategoryId = @CategoryId, SubCategoryId = @SubCategoryId, SaleTypeId = @SaleTypeId, StartDate = @StartDate, ExpiryDate = @ExpiryDate, Currency = @Currency, AvailableQuantity = @AvailableQuantity, Price = @Price, WarrantyId = @WarrantyId, ConditionId = @ConditionId, Brand = @Brand, CountryofOrigin = @CountryofOrigin, Model = @Model, Serial = @Serial, Certificate = @Certificate, DeliveryId = @DeliveryId, Description = @Description, Feature = @Feature, discountoffer = @discountoffer, actualprice = @ActualPrice, offerexpiry = @offerexpiry, wholesaleqty = @wholesaleqty, wholesaleprice = @wholesaleprice, enabledeal = @enabledeal, demotime = @demotime WHERE (ProductKey = @ProductKey)">
        <InsertParameters>
            <asp:ControlParameter ControlID="TextBox1" Name="ProductName" PropertyName="Text" />
            <asp:ControlParameter ControlID="DropDownList1" Name="SizeId" PropertyName="SelectedValue" />
            ...
            <asp:ControlParameter ControlID="DropDownList4" Name="SaleTypeId" PropertyName="SelectedValue" />
            <asp:ControlParameter ControlID="TextBox2" Name="StartDate" PropertyName="Text" />
            <asp:ControlParameter ControlID="TextBox3" Name="ExpiryDate" PropertyName="Text" />
            <asp:ControlParameter ControlID="TextBox4" Name="Price" PropertyName="Text" />
            <asp:ControlParameter ControlID="DropDownList5" Name="WarrantyId" PropertyName="SelectedValue" />
            <asp:ControlParameter ControlID="DropDownList6" Name="ConditionId" PropertyName="SelectedValue" />
            <asp:ControlParameter ControlID="TextBox6" Name="Brand" PropertyName="Text" />
            <asp:ControlParameter ControlID="TextBox7" Name="CountryOrigin" PropertyName="Text" />
            <asp:ControlParameter ControlID="TextBox8" Name="Model" PropertyName="Text" />
            <asp:ControlParameter ControlID="TextBox9" Name="Serial" PropertyName="Text" />
            <asp:ControlParameter ControlID="TextBox10" Name="Certificate" PropertyName="Text" />
            ...
            <asp:ControlParameter ControlID="TextBox5" Name="AvailableQuantity" PropertyName="Text" />
            ...
            <asp:ControlParameter ControlID="TextBox11" Name="offerexpiry" PropertyName="Text" />
        ...
        <UpdateParameters>
            ...
            <asp:ControlParameter ControlID="DropDownList6" Name="ConditionId" PropertyName="SelectedValue" />
            <asp:ControlParameter ControlID="TextBox6" Name="Brand" PropertyName="Text" />
            <asp:ControlParameter ControlID="TextBox7" Name="CountryofOrigin" PropertyName="Text" />
            <asp:ControlParameter ControlID="TextBox8" Name="Model" PropertyName="Text" />
            <asp:ControlParameter ControlID="TextBox9" Name="Serial" PropertyName="Text" />
            <asp:ControlParameter ControlID="TextBox10" Name="Certificate" PropertyName="Text" />
            <asp:ControlParameter ControlID="DropDownList7" Name="DeliveryId" PropertyName="SelectedValue" />
