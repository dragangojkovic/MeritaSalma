<%@ Page Title="" Language="C#" MasterPageFile="~/AdminSite.master" AutoEventWireup="true" CodeFile="profilecategory.aspx.cs" Inherits="Admin_usercontrol_type" %>
...
View & Edit </h3>
                       ...
                       <div class="col-md-3">
                        ...
                        <div class="table-responsive">
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" PageSize="30" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="ProfileSpecialityID" DataSourceID="SqlDataSource1" EmptyDataText="There are no data records to display.">
                                <Columns>
                                    <asp:CommandField ShowEditButton="True" />
                                    <asp:BoundField DataField="ProfileSpecialityID" HeaderText="Profile Category ID" ReadOnly="True" SortExpression="ProfileSpecialityID" />
                                    <asp:BoundField DataField="ProfileSpeciality" HeaderText="Profile Category" SortExpression="ProfileSpeciality" />
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" DeleteCommand="DELETE FROM [ProfileSpeciality] WHERE [ProfileSpecialityID] = @ProfileSpecialityID" InsertCommand="INSERT INTO [ProfileSpeciality] ([ProfileSpeciality], [Status]) VALUES (@ProfileSpeciality, @Status)" ProviderName="<%$ ConnectionStrings:DefaultConnection.ProviderName %>" SelectCommand="SELECT [ProfileSpecialityID], [ProfileSpeciality], [Status] FROM [ProfileSpeciality]
WHERE  (Status = @status) AND (ProfileSpeciality LIKE N'%' + @key + N'%')" UpdateCommand="UPDATE [ProfileSpeciality] SET [ProfileSpeciality] = @ProfileSpeciality, [Status] = @Status WHERE [ProfileSpecialityID] = @ProfileSpecialityID">
                                <DeleteParameters>
