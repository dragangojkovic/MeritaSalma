...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
 ...
 <asp:RadioButtonList ID="RadioButtonList1" runat="server" RepeatDirection="Horizontal">
    ...
    <asp:CustomValidator ID="CustomValidator1" runat="server" CssClass="required" ErrorMessage="Please Accept to terms and conditions"  ClientValidationFunction="ValidateCheckBox" ValidationGroup="r"></asp:CustomValidator><br />
        ...
        <div class="form-group">
          <div class="col-md-12"> 
                <asp:Button runat="server" OnClick="CreateUser_Click" Text="Register" ID="CreateUser" ValidationGroup="r" OnClientClick="if (!Page_ClientValidate('r')){ return false; } this.disabled = true; this.value = 'Logging...';" UseSubmitBehavior="False" />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" InsertCommand="INSERT INTO Profile(AccountMasterType, InsertDate, UserName, IP, UserApproval, AdminApproval, Emailaddress, VendorName) VALUES (@AccountMaster, GETDATE(), @UserName, @IP, @UserApproval, @AdminApproval, @Emailaddress, @VendorName)" ProviderName="<%$ ConnectionStrings:DefaultConnection.ProviderName %>">
        <InsertParameters>
