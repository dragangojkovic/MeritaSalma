        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">  <br /><br /><br /><br /><br />
                    ...
                    <br />
 <div id="message" runat="server" visible="false" class="alert alert-success" role="alert">Hi, <br />  You have successfully registered with onlinehcs.com. A welcome email containing your username and password has been sent to your registered email address for your future reference.<br />
     <br />
