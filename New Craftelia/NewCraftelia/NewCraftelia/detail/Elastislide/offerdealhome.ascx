...
<div>
		...
		<link rel="stylesheet" type="text/css" href="<%= Page.ResolveClientUrl("~/Elastislide/css/elastislide.css")%>" />
 ...
 <asp:LinkButton ID="LinkButton1" CommandName="Details" runat="server" CssClass="thumb">
    ...
    <h5>
		...
		<script type="text/javascript" src="<%= Page.ResolveClientUrl("~/Elastislide/js/jquery.elastislide.js")%>"> </script>
