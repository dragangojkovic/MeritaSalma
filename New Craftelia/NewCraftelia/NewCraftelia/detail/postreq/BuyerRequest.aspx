<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeFile="BuyerRequest.aspx.cs" Inherits="BuyerRequest" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="mainbg">
     ...
     <script>
      ...
      <asp:Label ID="Label1" runat="server" Text="Wanted Item"></asp:Label></h3></div> 
            <br />
        <asp:LinkButton ID="LinkButton1" runat="server"  ForeColor="#333333" Enabled="false">Offer Sent Today</asp:LinkButton> <asp:LinkButton ID="LinkButton2" runat="server"  ForeColor="white" CssClass="badge badge-success" Enabled="false"></asp:LinkButton>
           <asp:LinkButton ID="LinkButton3" runat="server" CssClass="pull-right text-color" PostBackUrl="~/postreq/applied.aspx" CausesValidation="False" Font-Bold="True">Applied Items</asp:LinkButton> <br />
               <br />
        ...
        <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource1" OnItemCommand="ListView1_ItemCommand" OnItemDataBound="ListView1_ItemDataBound">
            <ItemTemplate>
             ...
             <div class="hidden-lg" style="padding:3px; border-bottom:1px solid #ccc; margin-bottom:10px;"></div>    </div>
                  <div class="col-md-2">
                  <asp:Button ID="Button1" runat="server" Text="Send Offer" CommandName="SendOffer" OnClientClick="if (!Page_ClientValidate('msg')){ return false; } this.disabled = true; this.value = 'Processing...';" UseSubmitBehavior="False"  CssClass="btn btn-color btn-xs" />
                </div>
            </div>
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" InsertCommand="INSERT INTO ApplyRequest(PostARequestId, UserName, ApplyDate, Status, ReadStatus) VALUES (@PostARequestId, @UserName, GETDATE(), @Status, @Readstatus)" ProviderName="<%$ ConnectionStrings:DefaultConnection.ProviderName %>" SelectCommand="SELECT COUNT(Status) AS Offer FROM ApplyRequest WHERE (UserName = @UserName) AND (CAST(ApplyDate AS date) = CAST(GETDATE() AS date))">
            <InsertParameters>
                ...
                <asp:Parameter DefaultValue="unread" Name="Readstatus" />
            </InsertParameters>
            <SelectParameters>
                <asp:ControlParameter ControlID="HiddenField1" DefaultValue="Nauna" Name="UserName" PropertyName="Value" />
            </SelectParameters>
