...
<div class="col-xs-3 col-md-2"> 
    <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource1" OnItemCommand="ListView1_ItemCommand">
        <ItemTemplate>
  <asp:LinkButton ID="LinkButton2" runat="server" Font-Bold="True" CommandName="cart" ><i class="fa fa-shopping-cart" aria-hidden="true"></i> <asp:Label ID="Label1" runat="server" Text='<%# Eval("TotalCart") %>'></asp:Label> Cart </asp:LinkButton>
        </ItemTemplate>
    </asp:ListView>
