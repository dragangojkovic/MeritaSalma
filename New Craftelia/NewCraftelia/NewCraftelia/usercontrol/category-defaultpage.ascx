...
<nav class="sidebar">
 ...
 <li class="dropdown">
       ...
       <%--  <a class="dropdown-toggle" data-toggle="dropdown" href="#">--%>
         ...
         <asp:LinkButton ID="LinkButton1" runat="server" data-toggle="dropdown" CausesValidation="False" CommandName="CDetails" CssClass="dropdown-toggle">
        

      
        &nbsp;    <asp:Image ID="Image8" runat="server" ImageUrl='<%# Eval("Icon") %>' Height="15px" ImageAlign="AbsMiddle" Visible="False" /> 
