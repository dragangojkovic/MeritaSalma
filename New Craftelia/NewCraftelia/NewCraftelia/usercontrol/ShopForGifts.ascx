<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShopForGifts.ascx.cs" Inherits="usercontrol_ShopForGifts" %>
            ...
            <div class="s-product" style="background:white">
                ...
                <asp:LinkButton ID="LinkButton1" CommandName="Details" runat="server">
                    ...
                    <h6>
                        ...
                        <asp:Label Font-Italic="False" ID="Label4" runat="server">
                            <%# Eval("Currency") %>
                        </asp:Label>
                        <asp:Label Font-Italic="False" ID="Label9" runat="server" Text='<%# Eval("Price") %>'> </asp:Label> <small> <asp:Label ID="Label11" runat="server" Font-Strikeout="True" Font-Overline="False" Text=<%# Eval("ActualPrice") %>> </asp:Label> <asp:Label ID="Label16" Visible="false" runat="server" > Per <%# Eval("demotime") %> week(s) </asp:Label> <br /></small>
                        <span class="pull-right" style="margin-top:-15px">
                        <asp:Label ID="Label22" runat="server" Text='<%# Eval("CategoryName") %>'></asp:Label> <br />   <asp:Label ID="Label23" runat="server" Text='<%# Eval("SCategoryname") %>'></asp:Label></span>
                        <div class="discount" style="border:none" runat="server" visible="false">
                            <br />
                            <asp:Label ID="Label12" runat="server" Text='<%# Eval("discountoffer") %>' Visible="false"> </asp:Label>
                            <asp:Label ID="Label13" runat="server"> -
                                <%# Eval("discountoffer") %>%</asp:Label> &nbsp;
                            <asp:Label ID="Label15" runat="server" Text='<%# Eval("enabledeal") %>' Visible="false" Font-Size="10px"></asp:Label>
                        </div>
