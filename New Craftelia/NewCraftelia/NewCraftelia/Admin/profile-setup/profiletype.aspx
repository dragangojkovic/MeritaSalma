<%@ Page Title="" Language="C#" MasterPageFile="~/AdminSite.master" AutoEventWireup="true" CodeFile="profiletype.aspx.cs" Inherits="Admin_usercontrol_type" %>
...
View & Edit </h3>
                       ...
                       <div class="col-md-3">
                        ...
                        <div class="table-responsive">
                            ...
                            <asp:GridView ID="GridView1" runat="server" PageSize="30" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="ProfileCategoryID" DataSourceID="SqlDataSource1" EmptyDataText="There are no data records to display.">
                                <Columns>
                                    <asp:CommandField ShowEditButton="True" />
                                    <asp:BoundField DataField="ProfileCategoryID" HeaderText="Profile Type ID" ReadOnly="True" SortExpression="ProfileCategoryID" />
                                    <asp:BoundField DataField="ProfileCategory" HeaderText="Profile Type" SortExpression="ProfileCategory" />
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" DeleteCommand="DELETE FROM [ProfileCategory] WHERE [ProfileCategoryID] = @ProfileCategoryID" InsertCommand="INSERT INTO [ProfileCategory] ([ProfileCategory], [Status]) VALUES (@ProfileCategory, @Status)" ProviderName="<%$ ConnectionStrings:DefaultConnection.ProviderName %>" SelectCommand="SELECT [ProfileCategoryID], [ProfileCategory], [Status] FROM [ProfileCategory]
WHERE  (Status = @status) AND (ProfileCategory LIKE N'%' + @key + N'%')" UpdateCommand="UPDATE [ProfileCategory] SET [ProfileCategory] = @ProfileCategory, [Status] = @Status WHERE [ProfileCategoryID] = @ProfileCategoryID">
                                <DeleteParameters>
