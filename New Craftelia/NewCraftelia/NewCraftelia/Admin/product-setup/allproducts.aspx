...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
	...
	<div class="row">
					...
					<asp:LinkButton ID="LinkButton1" runat="server">
						<div class="form-div">
							...
							<div class="text-center">
								<asp:Image ID="Image2" runat="server" ImageUrl='<%# Eval("CoverImage") %>' Width="150px" Height="150px" />
							</div>
							...
							<h6>
								<i>
									<asp:Label ID="Label5" runat="server" Text='<%# Eval("Currency") %>' Font-Italic="False"></asp:Label>
									<asp:Label Font-Italic="False" ID="Label4" runat="server" Text='<%# Eval("Price") %>'></asp:Label>
								</i>
							...
							<h6>
								<small>User  Approval:
									<asp:Label ID="Label10" runat="server" Text='<%# Eval("UserApproval") %>' Font-Bold="True"></asp:Label>
									<br />
									Admin  Status:
									<asp:Label ID="Label6" runat="server" Text='<%# Eval("AdminApproval") %>' Font-Bold="True"></asp:Label>
									<br />
									Featured  Status:
									<asp:Label ID="Label7" runat="server" Text='<%# Eval("FeatureStatus") %>' Font-Bold="True"></asp:Label>
									<br />
									<asp:Label ID="Label9" runat="server" Text='<%# Eval("salestype") %>' Font-Bold="True" Visible="false"></asp:Label>
									<br />

									Seller Name:  
									<asp:Label ID="Label11" runat="server" Text='<%# Eval("vendorname") %>' Font-Bold="True"></asp:Label>
								</small>
							</h6>
							<hr style="margin-bottom: 8px;" />
							<h6>
							...
							<hr style="margin-bottom: 8px;" />
							<small class="pull-right">
								<asp:LinkButton ID="LinkButton4" runat="server" CssClass="text-danger" CommandName="Edit">Edit</asp:LinkButton>
								| 
								<asp:LinkButton ID="LinkButton5" runat="server" CommandName="Feature" CssClass="text-success">Featured</asp:LinkButton>
							</small>
							<br />
						</div>
					</asp:LinkButton>
		...
		<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" ProviderName="<%$ ConnectionStrings:DefaultConnection.ProviderName %>" SelectCommand="SELECT distinct dbo.Profile.VendorName FROM dbo.Profile INNER JOIN dbo.Products ON dbo.Profile.UserName = dbo.Products.UserName where dbo.Profile.VendorName is not null  ORDER BY dbo.Profile.VendorName"></asp:SqlDataSource>
	</div>
</asp:Content>