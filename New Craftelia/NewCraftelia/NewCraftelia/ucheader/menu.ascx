...
<div class="col-xs-4 col-md-3 nopadding" id="admin" runat="server" visible="false">
    <asp:LinkButton ID="LinkButton23" runat="server" PostBackUrl="~/Admin/Admin-Dashboard.aspx">Go To Admin Dashboard</asp:LinkButton>
    </div>



<div class="col-xs-4 col-md-3 nopadding" id="buyer" runat="server" visible="false">      
                                  
                                      
                                           <div >

                                        <div class="dropdown">
                                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="font-weight:bold;"><i class="fa fa-user"></i>    My Account <i class="fa fa-angle-down "></i> </a>
...
<div class="col-xs-4 col-md-3 nopadding"  id="both" runat="server" visible="false">      
...
<div class="col-xs-4 col-md-3 nopadding" id="vendor" runat="server" visible="false">      
