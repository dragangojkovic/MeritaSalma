<%@ Control Language="C#" AutoEventWireup="true" CodeFile="searchbar.ascx.cs" Inherits="usercontrol_searchbar" %>
 ...
 <div class="col-md-4"><br />
                    ...
                    <div class="input-group-btn">
                        ...
                        <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource2" DataTextField="CategoryName" DataValueField="CategoryId" ValidationGroup="search" AppendDataBoundItems="True" Height="30px">
